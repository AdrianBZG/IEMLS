...
import controller.MachineLearningAgentConfigurationController;
...
import view.ObjectView.QLearningAgentView;
...
public class QLearningAgent extends Agent {
     ...
     * @param agent
     */
    public QLearningAgent(QLearningAgent agent) {
    ...
    public Object clone() throws CloneNotSupportedException {
        return new QLearningAgent(this);
    }
